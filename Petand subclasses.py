...
class Dog(Pet):
    ...
    def chasing_cats(self):
        return "Get over here you kitty Cat"
    def mood(self):
        if (self.hunger<=self.hunger_threshold & self.boredom<=self.boredom_threshold):
            return "Happy Pappy"
        elif (self.hunger>self.hunger_threshold):
            return "Hungry and Grumpy"
        else:
            return "Bored and Hungry, Feed me, Entertain me"
